...
def print_results(results_dic, results_stats_dic, model,
    ...
    Parameters:
        ...
        results_stats_dic - Results statistics Dictionary
        model - CNN model architecture used (string)
        print_incorrect_dogs - True prints incorrectly classified dogs (bool)
        print_incorrect_breed - True prints incorrectly classified breeds (bool)
    ...
    if print_incorrect_dogs and (
        ...
        for key in results_dic:
            if sum(results_dic[key][3:]) == 1:
                print("Pet Image: {:35} Real Label: {:>26}   Classifier: {:>30}".format(
